...
func (e MedicineEdges) PrescriptionsOrErr() ([]*Prescription, error) {
	if e.loadedTypes[0] {
...
// QueryPrescriptions queries the prescriptions edge of the Medicine.
func (m *Medicine) QueryPrescriptions() *PrescriptionQuery {
	return (&MedicineClient{config: m.config}).QueryPrescriptions(m)
}
